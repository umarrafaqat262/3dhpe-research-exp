...
\begin{tikzpicture}[
 ...
 \foreach \i/\lbl [count=\c from 0] in
   {0/Pel,1/RHp,2/RKn,3/RAn,4/LHp,5/LKn,6/LAn,7/Spn,8/Thx,9/Nck,10/Hd,
 ...
 \foreach \i/\lbl [count=\c from 0] in
   {0/Pel,1/RHp,4/LHp,7/Spn,2/RKn,5/LKn,8/Thx,3/RAn,6/LAn,9/Nck,
...
$\mathcal{O}(J)$ per layer and adds no parameters. KinecMamba therefore keeps
the linear-time behaviour of its backbone while changing only the order in
which joints enter the scan.
