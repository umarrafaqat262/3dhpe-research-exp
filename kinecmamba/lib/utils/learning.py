...
def load_backbone(args):
    ...
    if args.backbone=='PoseMamba':
        ...
        model_backbone = PoseMamba(num_frame=args.maxlen, embed_dim_ratio=args.dim_feat, mlp_ratio = args.mlp_ratio, depth = args.depth, in_chans=in_chans, use_ssi=use_ssi)
