...
parameters. Chapter~\ref{ch:results} set out the evaluation of
KinecMamba on Human3.6M at approximately 1.26M parameters, which places
it in the same efficiency tier as the smallest baselines
compared against, namely PoseMamba-S and SasMamba. Its accuracy
