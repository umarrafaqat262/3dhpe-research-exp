...
compared against, namely PoseMamba-S and SasMamba. Its accuracy on the
benchmark, the MPI-INF-3DHP evaluation, and the scan-order ablation depend
on training runs that had not finished when this chapter was written, so
those figures are reported as pending rather than final. PoseMamba-S, the
closest baseline in both architecture and parameter budget, is the reference
point for that comparison once it completes.
